...
import type { NewTask, User } from '../App';
...
export default function NewTaskModal({ onClose, onAddTask, allMembers, currentUserId, users, isProjectAdmin }: NewTaskModalProps) {
    ...
    return (
        <ModalBackdrop>
            <ModalContent onClick={(e) => e.stopPropagation()}>
                <Title>새 작업 만들기 <CloseButton onClick={onClose}>X</CloseButton></Title>
